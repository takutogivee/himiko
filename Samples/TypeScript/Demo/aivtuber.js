//TODO: meboの定数
const MEBO_API_KEY ='b7ec3bc4-8abb-45ec-be8d-56a1a253713c1875518aeef5f';
const MEBO_AGENT_ID = 'ae7825ab-c011-4d22-8d4f-7fc6d7e6931d186e83ca38515d';

// TODO: VOICEVOXのURL (デフォルトの設定の場合は変える必要なし)
const VOICE_VOX_API_URL = "http://localhost:50021";

// TODO: ライブ配信するYouTubeのVideoID
const YOUTUBE_VIDEO_ID = 'N0QZdlTCTVY';
...
const onClickSend = () => {
    ...
    handleLiveComment(utterance.value, '');
    utterance.value = "";
}
...
const startLive = () => {
    ...
    let startLiveButton = document.querySelector("#bottomBox");
